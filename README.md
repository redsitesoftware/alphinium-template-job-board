[![Forge with Alphinium](https://img.shields.io/badge/🔨_Forge_with_Alphinium-Build_Your_Version-6366f1?style=for-the-badge&logo=github)](https://alphinium.com/forge?template=job-board)
...
Expo React Native demo for browsing jobs, viewing role details, submitting applications, and posting new roles.

## Features
- 16 seeded jobs across Tech, Marketing, Design, and Operations
- Home, job detail, and post-a-job flows driven by a simple app state machine
- Application and posting callouts for the alphinium-forms addon
- Web support via Expo on port 8091

## Run
```bash
npm install --legacy-peer-deps
npx expo install react-dom react-native-web @expo/metro-runtime
CI=1 npx expo start --web --port 8091 --clear
```
- 🎨 Dark mode ready
